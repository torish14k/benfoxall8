...
const TIMEOUT = 5000;
describe('FMS_fuzzTestNum', function () {
    console.log("FMS_fuzzTestNum===start");
   ...
   it('FMS_fuzzTestNum_0200_promise', 0, async function (done) {
     ...
     */
     it('FMS_fuzzTestNum_0300_param_01_callback', 0, async function (done) {
        ...
        console.log("FMS_fuzzTestNum_0300_param_01_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
    ...
    it('FMS_fuzzTestNum_0300_param_01_promise', 0, async function (done) {
        ...
        var isReleaseCache = arrayTest();
        console.log("FMS_fuzzTestNum_0300_param_01_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_02_callback', 0, async function (done) {
         ...
         console.log("FMS_fuzzTestNum_0300_param_02_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
     ...
     it('FMS_fuzzTestNum_0300_param_02_promise', 0, async function (done) {
         ...
         var isReleaseCache = booleanTest();
         console.log("FMS_fuzzTestNum_0300_param_02_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_03_callback', 0, async function (done) {
         ...
         console.log("FMS_fuzzTestNum_0300_param_03_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
     ...
     it('FMS_fuzzTestNum_0300_param_03_promise', 0, async function (done) {
         ...
         var isReleaseCache = functionTest();
         console.log("FMS_fuzzTestNum_0300_param_03_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_04_callback', 0, async function (done) {
         ...
         console.log("FMS_fuzzTestNum_0300_param_04_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
     ...
     it('FMS_fuzzTestNum_0300_param_04_promise', 0, async function (done) {
         ...
         var isReleaseCache = nullTest();
         console.log("FMS_fuzzTestNum_0300_param_04_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_05_callback', 0, async function (done) {
         ...
         console.log("FMS_fuzzTestNum_0300_param_05_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
     ...
     it('FMS_fuzzTestNum_0300_param_05_promise', 0, async function (done) {
         ...
         var isReleaseCache = numberTest();
         console.log("FMS_fuzzTestNum_0300_param_05_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_06_callback', 0, async function (done) {
         ...
         console.log("FMS_fuzzTestNum_0300_param_06_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
     ...
     it('FMS_fuzzTestNum_0300_param_06_promise', 0, async function (done) {
         ...
         var isReleaseCache = objectTest();
         console.log("FMS_fuzzTestNum_0300_param_06_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_07_callback', 0, async function (done) {
         ...
         console.log("FMS_fuzzTestNum_0300_param_07_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
     ...
     it('FMS_fuzzTestNum_0300_param_07_promise', 0, async function (done) {
         ...
         var isReleaseCache = stringTest();
         console.log("FMS_fuzzTestNum_0300_param_07_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_08_callback', 0, async function (done) {
         ...
         console.log("FMS_fuzzTestNum_0300_param_08_callback releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
     ...
     it('FMS_fuzzTestNum_0300_param_08_promise', 0, async function (done) {
         ...
         var isReleaseCache = undefinedTest();
         console.log("FMS_fuzzTestNum_0300_param_08_promise releaseForm isReleaseCache typeof:"+ typeof(isReleaseCache));
      ...
      */
      it('FMS_fuzzTestNum_0300_param_09_callback', 0, async function (done) {
         ...
         var formId = numberTest();
         console.log("FMS_fuzzTestNum_0300_param_09_callback releaseForm formId typeof:"+ typeof(formId) + ",formId:" + formId);
     ...
     it('FMS_fuzzTestNum_0300_param_09_promise', 0, async function (done) {
         ...
         var formId = numberTest();
         console.log("FMS_fuzzTestNum_0300_param_09_promise releaseForm formId typeof:"+ typeof(formId) + ",formId:" + formId);
     ...
     */
     it('FMS_fuzzTestNum_1400_param_01_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_01_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = arrayTest();
        console.log("FMS_fuzzTestNum_1400_param_01_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_01_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_01_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = arrayTest();
        console.log("FMS_fuzzTestNum_1400_param_01_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_02_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_02_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = booleanTest();
        console.log("FMS_fuzzTestNum_1400_param_02_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_02_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_02_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = booleanTest();
        console.log("FMS_fuzzTestNum_1400_param_02_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_03_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_03_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = functionTest();
        console.log("FMS_fuzzTestNum_1400_param_03_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_03_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_03_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = functionTest();
        console.log("FMS_fuzzTestNum_1400_param_03_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
     ...
     */
     it('FMS_fuzzTestNum_1400_param_04_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_04_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = nullTest();
        console.log("FMS_fuzzTestNum_1400_param_04_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_04_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_04_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = nullTest();
        console.log("FMS_fuzzTestNum_1400_param_04_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
     ...
     */
     it('FMS_fuzzTestNum_1400_param_05_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_05_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_05_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_05_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_05_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_05_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
     ...
     */
     it('FMS_fuzzTestNum_1400_param_06_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_06_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = objectTest();
        console.log("FMS_fuzzTestNum_1400_param_06_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_06_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_06_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = objectTest();
        console.log("FMS_fuzzTestNum_1400_param_06_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
     ...
     */
     it('FMS_fuzzTestNum_1400_param_07_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_07_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = stringTest();
        console.log("FMS_fuzzTestNum_1400_param_07_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_07_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_07_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = stringTest();
        console.log("FMS_fuzzTestNum_1400_param_07_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
     ...
     */
     it('FMS_fuzzTestNum_1400_param_08_callback', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_08_callback getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = undefinedTest();
        console.log("FMS_fuzzTestNum_1400_param_08_callback getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
    ...
    it('FMS_fuzzTestNum_1400_param_08_promise', 0, async function (done) {
        ...
        var bundleName = numberTest();
        console.log("FMS_fuzzTestNum_1400_param_08_promise getFormsInfoByModule bundleName typeof:"+ typeof(bundleName));

        var moduleName = undefinedTest();
        console.log("FMS_fuzzTestNum_1400_param_08_promise getFormsInfoByModule moduleName typeof:"+ typeof(moduleName));
