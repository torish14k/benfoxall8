...
describe('scene_test_1', function () {
    console.info('----scene_test_1----');
    ...
    it('removeMission_01', 0, async function (done) {
        ...
        for (var i = 0; i < data.length; i++) {
            if(data[i].baseAbility.bundleName != 'com.example.scene001'&& data[i].topAbility.bundleName != 'com.example.scene001'){
    ...
    it('clearMissions_01', 0, async function (done) {
        var info = await abilitymanager.clearMissions();
        done();
    })
