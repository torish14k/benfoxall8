...
describe('scene_test_5', function () {
    console.info('----scene_test_5----');
    ...
    it('removeMission_05', 0, async function (done) {
        ...
        for (var i = 0; i < data.length; i++) {
            if(data[i].baseAbility.bundleName != 'com.example.scene005'&& data[i].topAbility.bundleName != 'com.example.scene005'){
