...
describe('scene_test_3', function () {
    console.info('----scene_test_3----');

    it('startlauncher_scene3_01', 0, async function (done) {
    ...
    it('removeMission_03', 0, async function (done) {
        ...
        for (var i = 0; i < data.length; i++) {
            if(data[i].baseAbility.bundleName != 'com.example.scene003'&& data[i].topAbility.bundleName != 'com.example.scene003'){
    ...
    it('startAbility_scene3_01', 0, async function (done) {
        var promise = await featureAbility.startAbility(
            {
                want:
                {
    ...
    it('startAbility_scene3_02', 0, async function (done) {
        var promise = await featureAbility.startAbility(
            {
                want:
                {
    ...
    it('startAbility_scene3_03', 0, async function (done) {
        var promise = await featureAbility.startAbility(
            {
                want:
                {
    ...
    it('startlauncher_scene3_02', 0, async function (done) {
        var promise = await featureAbility.startAbility(
            {
                want:
                {
    ...
    it('clearMissions_03', 0, async function (done) {
        var info = await abilitymanager.clearMissions();
        done();
    })
})
